...
- Это гарантирует, что **тяжелые каскады перерасчетов или очистка памяти (`destroy()`) внутри Чата физически не смогут зааффектить или сломать работу Формы документов**, так как их реактивные графы изолированы на уровне инстансов классов.
:::
...
::: tip Когда это уместно и необходимо использовать
