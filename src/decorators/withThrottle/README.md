...
```
[Сырой Сигнал Мыши] (Спам 400 тиков)↓[withThrottleComputed] (Сжатие потока)↓ (Тикает строго 1 раз в 300 мс)[Асинхронный Ресурс] (loading: true включается РOВНО 1 раз в 300 мс)
```
